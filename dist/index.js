...
const mostrarEstudiantes_1 = __importDefault(require("./mostrarEstudiantes"));
...
(0, mostrarEstudiantes_1.default)(e1);
...
arregloEstudiantes.forEach((elemento) => {
    ...
    if (typeof elemento === 'object' && // Verifica que sea un objeto
        ...
        (0, mostrarEstudiantes_1.default)(elemento); // Llama a la función para mostrar información del estudiante
    }
});
